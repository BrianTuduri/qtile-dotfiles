...
pipeline {
    ...
    parameters {
        ...
        // remote parameters
        string(name: 'remoteBaseNexusURL', defaultValue: 'https://nexus-example.geocom.com.py:4443', description: 'URL del repositorio remoto en HTTPS o SSH de GITLAB (REMOTO)') // local & requerido
