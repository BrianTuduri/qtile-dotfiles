            ...
            steps {
                script {
                    ...
                    dir ('repository/pipelines_in_testing') { 
                        def params = load env.PATH_DEFINED_PARAMETERS // params.projectPathWithNamespaceuy-com-geocom-scm/devops/release-automation-pipelines/parameters.groovy // lista // getEnv('ENV_PARAMETERS_PATH')
