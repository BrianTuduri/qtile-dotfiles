        ...
        stage('Set vars . . .') {
            steps {
                script {
                    ...
                    configFileYmlProvider([configFileYml(fileId: 'af5f8d3f-79e7-4ed3-8241-c0b831982733', targetLocation: 'settings.xml')]) {
                        echo "hola hola"
                    }
                }
            }
            ...
            steps {
                script {
                    dir(CONFIG["CHECKOUT_FOLDER"]) {
                        ...
                        // set configs files
                        //configFileYmlProvider([configFileYml(fileId: mavenProject ? CONFIG["MAVEN_CONFIG_ID"] : CONFIG["GRADLE_CONFIG_ID"],
