...
pipeline {
    ...
    parameters {
        ...
        // remote parameters
        string(name: 'remoteBaseNexusURL', defaultValue: 'https://nexus-gama.geocom.com.uy:4443', description: 'URL del repositorio remoto en HTTPS o SSH de GITLAB (REMOTO)') // local & requerido
        string(name: 'target_nexus_credentials', defaultValue: 'nexus_gama_token', description: 'Credenciales de NEXUS (REMOTO) en Jenkins.') // LOCAL
