...
pipeline {
    ...
    parameters {
        choice(name: 'branch', choices: ['master'], description: 'Select branch')
                    ...
                    sshagent(['cy5ymCych3DLs29tpAnCC2qF0ze5RdPT']) {
                        checkout([
                            ...
                            userRemoteConfigs: [[
                                ...
                                url: 'git@gitlab.geocom.com.uy:uy-com-geocom-scm/kafka-deploy.git'
                            ]]
                        ])
                        dir('client') {
                            ...
                            dir('Environments') {
                                sh """
                                    git checkout ${environmentsBranch}
                                    git pull
                                """
                            }
                        } 
