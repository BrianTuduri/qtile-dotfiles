            ...
            steps{
                script {
                    checkout changelog: false, poll: false, scm: [$class: 'GitSCM',
                        branches: [[name: "*/${SCM_BRANCH}"]], doGenerateSubmoduleConfigurations: false,
                        extensions: [[$class: 'CloneOption', depth: 1, noTags: true, reference: '', shallow: true],
                        [$class: 'LocalBranch', localBranch: SCM_BRANCH],
                        ...
                        url: 'git@gitlab.geocom.com.uy:uy-com-geocom-scm/devops/scm-pipelines.git']]]
                }
            }
        }
            ...
            steps {
                script {
                    ...
                    withCredentials([usernamePassword(credentialsId: params.registry_remote_credentials, usernameVariable: 'GITLAB_USER', passwordVariable: 'GITLAB_TOKEN')]) {
                        dir('repository/migraciones/Registry') {
                            def pythonPath = "${WORKSPACE}/repository/migraciones/Registry/gitlab_management.py"
                            def command = "python3 ${pythonPath}'${newGitLabBaseDomain}' '${GITLAB_TOKEN}' '${newGitLabPath}'"
