...
pipeline {
    ...
    parameters {
        // registry
        string(name: 'registry_url_local', defaultValue: 'registry_token_migraciones', description: 'URL del repositorio de imagenes (LOCAL) Ejemplo: registry.gitlab.geocom.com.uy:5005') // local & requerido
