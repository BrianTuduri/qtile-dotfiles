        ...
        stage('Subiendo imagen a registry remoto docker [REMOTO]. . .') {
            steps {
                script {
                    ...
                    def outPut = executeCommand("python test/gitlab_management.py -P ${projectName}/${namespaceName}") == "False" ? false : true
                    // python3 gitlab_management.py 'https://gitlab.geocom.com.uy' 'glpat-LS6--2HwWMzVB7eBtUcL' 'uy-com-geocom-scm/devops/terraform_modules' 'kafka-ui'
                    docker.withTool('docker'){
