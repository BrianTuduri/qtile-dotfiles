////////////////////        CONFIGURAR    ////////////////////////////////////
def projectPathWithNamespace = "uy-com-geocom-alkosto/geopos2-alkosto"
...
def defineCommonParameters(String pathWithNamespace) {
    ...
    //                          name        scriptId           referencedParam
        ...
        choice(name: 'tarea', choices: ['build', 'release', 'regenerate_version'], description: 'Selecciona el tipo de tarea que desea ejecutar')
    ]
}
