...
def mavenSpecificParameters() {
    [
        ...
        choice(name: 'tool', defaultValue: ['Maven'], description: 'Type tool Hidden parameter (Maven or Gradle)')
    ]
}
...
def gradleSpecificParameters() {
    [
        ...
        choice(name: 'tool', defaultValue: ['Gradle'], description: 'Type tool (Gradle or Maven)')
    ]
}
