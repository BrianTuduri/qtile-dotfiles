return [
    choice(name: 'projectPathWithNamespace', choices: ['uy-com-geocom-scm/devops/release-automation-pipelines'], description: 'Path completo al proyecto (incluyendo namespace) Ej: uy-com-geocom-scm/devops/release-automation-pipelines'),
    [
